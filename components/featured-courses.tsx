...
export function FeaturedCourses() {
  ...
  const activeCourses = [
    ...
    // ФИНКИ - Христијан
    {
      ...
      link: "https://forms.gle/F33Yb99UvT6sC5L6A",
      status: t("courses.status.enrolling"),
      faculty: "ФИНКИ" as Faculty,
    },
    {
      ...
      color: "bg-cyan-100 text-cyan-700",
      link: "https://forms.gle/GurCgJLbw7ZvShGq7",
      status: t("courses.status.enrolling"),
      faculty: "ФИНКИ" as Faculty,
    },
    // ФИНКИ - Стефан, Борис
    {
      ...
      link: "https://forms.gle/yzAytKe4hHJPFgQ1A",
      status: t("courses.status.enrolling"),
      faculty: "ФИНКИ" as Faculty,
    },
    {
      ...
      color: "bg-teal-100 text-teal-700",
      link: "https://forms.gle/1egqKdKmQxBMfDed8",
      status: t("courses.status.enrolling"),
      faculty: "ФИНКИ" as Faculty,
    },
    {
      ...
      color: "bg-teal-100 text-teal-700",
      link: "https://forms.gle/NWtbTqTSD3cEwtAs9",
      status: t("courses.status.enrolling"),
      faculty: "ФИНКИ" as Faculty,
    },
    {
      ...
      color: "bg-teal-100 text-teal-700",
      link: "https://forms.gle/FY3e9AfeK4wwPUfm9",
      status: t("courses.status.enrolling"),
      faculty: "ФИНКИ" as Faculty,
    },
    // ФИНКИ - Петар
    {
      ...
      link: "https://forms.gle/95C1PunzUH7xPb636",
      status: t("courses.status.enrolling"),
      faculty: "ФИНКИ" as Faculty,
    },
    // ФИНКИ - Борјан
    {
      ...
      link: "https://forms.gle/bS99zokATgMZu2Wb7",
      status: t("courses.status.enrolling"),
      faculty: "ФИНКИ" as Faculty,
    },
    {
      ...
      color: "bg-purple-100 text-purple-700",
      link: "https://forms.gle/DGrNAgobA7B3GWyx8",
      status: t("courses.status.enrolling"),
      faculty: "ФИНКИ" as Faculty,
    },
    // ФЕИТ - Јован Петровски
    {
      ...
      link: "https://forms.gle/KNSkWxjFvrorP4kg6",
      status: t("courses.status.enrolling"),
    ...
    },
    {
      ...
      color: "bg-yellow-100 text-yellow-700",
      link: "https://forms.gle/qbpPkv6QaSyqVj1J8",
      status: t("courses.status.enrolling"),
      faculty: "ФЕИТ" as Faculty,
    },
    // МФСС - Никола Коцевски
    {
      ...
      link: "https://forms.gle/1igWUKK5TqvFh31WA",
      status: t("courses.status.enrolling"),
    ...
    },
    {
      ...
      color: "bg-blue-100 text-blue-700",
      link: "https://forms.gle/FULkPBQs1RVx2Ewq6",
      status: t("courses.status.enrolling"),
      faculty: "МФС" as Faculty,
    },
  ];
