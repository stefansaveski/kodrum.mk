  ...
  const promoPacks = [
    {
      ...
      title: "Programming Combo Pack",
      description: "Perfect for aspiring programmers",
      courses: ["Structured Programming", "Algorithms and Data Structures"],
      originalPrice: "6,000 MKD",
      discountPrice: "4,800 MKD",
      savings: "1,200 MKD",
      discount: "20%",
      icon: <Star className="h-8 w-8" />,
      color: "from-blue-500 to-blue-600",
      features: [
        "2 Complete Programming Courses",
    ...
    },
    {
      ...
      title: "Math + Programming Bundle",
      description: "Strong foundation in math and coding",
      courses: [
        "Calculus/Math 1",
        "Structured Programming",
        "Discrete Mathematics",
      ],
      originalPrice: "7,700 MKD",
      discountPrice: "5,800 MKD",
      savings: "1,900 MKD",
      discount: "25%",
    ...
    },
    {
      id: "friends-discount",
      title: "Friends Pack",
      description: "Bring a friend and save together",
      courses: ["Any Course of Choice"],
      originalPrice: "Per Person: 3,500 MKD",
      discountPrice: "Per Person: 2,800 MKD",
      savings: "700 MKD each",
      discount: "20%",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {promoPacks.map((pack, index) => (
              <Card
                key={pack.id}
                className={`relative hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group ${
                  pack.popular
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="text-center bg-gradient-to-r from-teal-50 to-cyan-50 rounded-xl p-6">
                    ...
                    <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-teal-500 to-teal-600 text-white text-sm font-semibold rounded-full">
                      Save {pack.savings} ({pack.discount} OFF)
                    </div>
                  </div>
